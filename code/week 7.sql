...
BEGIN
   ...
   IF Count = 0  THEN -- 과목이 존재하지 않으면 새 과목 추가
	   ...
	   VALUES (CourseNO, CourseName,CourseRoom,courseDept,CourseCreait);
...
SELECT * FROM 남녀학생총수;
INSERT INTO 학생2
VALUES('s008','최동석','경기수원',2,26,'남','010-8886-6666','컴퓨터');
SELECT * FROM 남녀학생총수;
