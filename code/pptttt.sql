CREATE TABLE 과목2 (
	...
	이름 VARCHAR(20) NOT NULL, -- SHOWEBERGER AARON DAN(IEL)
	강의실 CHAR(5) NOT NULL,
...
ALTER TABLE 수강2 DROP COLUMN 등록날짜; -- 열 사젝
...
CREATE USER supermanager WITH PASSWORD 'krtpto'; -- crypto (비트코인) krypto(슈퍼맨의 개)
GRANT ALL PRIVILEGES ON DATABASE univdb25 TO supermanager; -- DB만 권한 부여
GRANT ALL PRIVILEGES ON 학생 2, 수강2, 과목2 TO supermanager; --테이블에서만 권한 부여

ALTER DATABASE univdb25 OWNER TO supermanager; -- 소유자도 벼녁ㅇ하면 모든 권한이 있다.
